...
public class Scope
{
    ...
    public void draw2d(Graphics g)
    {
        ...
        for (i = 0; i != rect.width; i++)
            pixels[i + rect.width * (rect.height / 2)] = 0x000000;
        int ycol = (plotXY) ? 0xFF00FF00 : 0x000000;
        ...
        if (!plotXY) {
            g.drawString("V", rect.x + rect.width - 10, rect.y + rect.height/2 + 15);
            // Current (Y-axis) label at top
            g.drawString("I", rect.x - 10 + rect.width/2, rect.y + 15);
        }
    }
    ...
    public void draw(Graphics g)
    {
        ...
        int voltColor = (value > 0) ? 0xFFFFFFFF : 0xFFFF0000;
